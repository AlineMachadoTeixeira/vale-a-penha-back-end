        ...
        <div class="menu__camada">
            ...
            <nav>
                <h4 class="menu__camada__um">
                    ...
                    <a class="icone__menu__login"href="login.php"><img class="icone__menu" src="assets/images/icone-menu.teste.png" alt="Ìcone de login"></a>
                ...
                <form action="" method="post">
                    ...
                    <div class="login__for">
                        ...
                        <div class="login__campos">
                            ...
                            <input id="confirmeemail" type="email" name="confirmeemail" placeholder="Confirme seu E-mail"
                                required>
                        </div>
                        ...
                        <div class="login__campos">
                            ...
                            <input id="confirmesenha" type="password" name="confirmesenha"
