    ...
    <div>
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="adm-status-inativo.php"  class="nav-link scrollto"><i class='bx bx-toggle-left' ></i>
              <span>Status Inativos</span></a>
          </li>

          <li><a href="adm-status-ativo.php" class="nav-link scrollto active"><i class='bx bx-toggle-right'></i>
